...
app.controller("workHourRulesCtrl", ["$scope", "$timeout", 'requests', function ($scope, $timeout, requests) {
    //------------- load page -----------------------
    ...
    $scope.CreateWorkSetting = function () {
        $scope.createWorkSetting = {
            ...
            allowedDelayAddToShortageHour: null,
            allowedHurryAddToShortageHour: null,
            extraHourRate: null,
            id: null,
            createdBy: null,
            createdAt: null,
    ...
    $scope.confirmCreate = function () {
        requests.postingData("WorkSettings/Update", $scope.createWorkSetting, function (response) {
